...
public class VKCore {
    ...
    public VKCore() throws ClientException, ApiException {
        ...
        int groupId;
        String access_token;
//        String configPathName = "src/main/resources/vkconfig.properties";
//        ClassLoader loader = Thread.currentThread().getContextClassLoader();
//        try(InputStream resourceStream = loader.getResourceAsStream(configPathName)) {
...
//        groupId = Integer.valueOf(prop.getProperty("group_id"));
        access_token = "5f7df972da45f876e95e57091ad70f5e5af0044fa28e40cc6b218fda56d6ba6899dbfd79f83242e73666e";
        groupId = 6756845;
